...
/**返回把当前时间化成millisecond */
DateFormat.prototype.getTime = function(date){
    if(date == null)
    {
        date = new Date();
    }
...
/**
 * 如果date1 大于 date2 返回1<br/>
 * 如果date1 小于 date2 返回-1<br/>
 * 如果date1 等于 date2 返回0
 * @param date1 Date对象
 * @param date2 Date对象
 * @returns {Number}
 */
DateFormat.prototype.compare = function(date1, date2){
...
/**日期化成字符串后的格式yyyy-MM-dd***/
DateFormat.pattern1 = "yyyy-MM-dd";
/**日期化成字符串后的格式yyyyMMddHHmmss***/
DateFormat.pattern2 = "yyyyMMddHHmmss";

/**日期化成字符串后的格式yyyy-MM-dd HH:mm:ss***/
DateFormat.pattern3 = "yyyy-MM-dd HH:mm:ss";