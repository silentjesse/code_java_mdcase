package utils.dcase.database.pool;
...
public class ConnectionPool {
	...
	*/
	...
	public static  ConnectionPool  getConnectionPool(String jdbcDriver, String dbUrl, String dbUsername, String dbPassword) throws Exception{
		ConnectionPool connectionPool = null;
		connectionPool = new ConnectionPool(jdbcDriver, dbUrl, dbUsername, dbPassword);
		try {
			connectionPool.createPool();
		} catch (Exception e) {
			throw (new Exception("initialize connection pool failure"));
		}
	...
	private void createConnections(int numConnections) throws SQLException {
	         ...
	         for (int x = 0; x < numConnections; x++) {
	          ...
	          try{
	        	  ...
	        	  System.out.println("create database failure "+e.getMessage());
	   
	          throw new SQLException();
	   
	          }
	   
	          System.out.println("connection pool get a new connection...");
	...
	*/
	...
	public synchronized Connection getConnection() throws SQLException {
	         ...
	         while (conn == null){
	          ...
	          // 则表明创建一批连接后也不可获得可用连接
	          if(waittime > 5000){
	        	  throw (new SQLException("connection pool exhaust "));
	          }
	         }
